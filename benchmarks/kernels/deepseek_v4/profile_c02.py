...
from benchmarks.kernels.deepseek_v4.c02_factories import (
    build_c02_global_prefill_chain_case,
    build_c02_standalone_case,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--prefill-request-batch", type=int, choices=(0, 1, 4), default=1
    )
...
def main() -> None:
    ...
    factory = (
        ...
        else build_c02_global_prefill_chain_case
    )
    case = factory(
        {
