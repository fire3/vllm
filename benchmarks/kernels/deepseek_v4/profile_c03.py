...
from benchmarks.kernels.deepseek_v4.c03_factories import (
    build_c03_prefill_swa_chain_case,
    build_c03_standalone_case,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--num-prefill-tokens", type=int, default=8192)
    parser.add_argument("--prefill-request-batch", type=int, choices=(1, 4), default=1)
...
def main() -> None:
    ...
    factory = (
        ...
        else build_c03_prefill_swa_chain_case
    )
    case = factory(
        {
