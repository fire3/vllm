...
class Scheduler(SchedulerInterface):
    def __init__(
        ...
        # the blocks as soon as the fence step completes. The env switch is
        # deliberately usable without a KV connector: the connector block
        # above is skipped entirely on plain TP serving, but the deferred-free
        # machinery (deferred_frees deque + seq fences) is initialized
